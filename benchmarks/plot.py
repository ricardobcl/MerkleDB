...
def load_csv(name, do_filter=True):
    csv1 = read_csv(('/Users/ricardo/github/BasicDB/_build/dev/dev1/basic_db/data/stats/current/' + name), do_filter)
    csv2 = read_csv(('/Users/ricardo/github/BasicDB/_build/dev/dev2/basic_db/data/stats/current/' + name), do_filter)
    csv3 = read_csv(('/Users/ricardo/github/BasicDB/_build/dev/dev3/basic_db/data/stats/current/' + name), do_filter)
    csv4 = read_csv(('/Users/ricardo/github/BasicDB/_build/dev/dev4/basic_db/data/stats/current/' + name), do_filter)
    return np.concatenate([csv1,csv2,csv3,csv4], axis=0)

def get_csv_names():
    f = []
    mypath='/Users/ricardo/github/BasicDB/_build/dev/dev1/basic_db/data/stats/current/'
...
dest_path = '/Users/ricardo/github/BasicDB/benchmarks/tests/local/'
